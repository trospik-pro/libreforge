...
object EffectLightEcoGiveMoney : Effect<NoCompileData>("lighteco_give_money") {
    ...
    override fun onTrigger(config: Config, data: TriggerData, compileData: NoCompileData): Boolean {
        ...
        user.deposit(currency, BigDecimal.valueOf(config.getDoubleFromExpression("amount", data)))
